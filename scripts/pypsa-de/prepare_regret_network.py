...
uc_params_optimistic = {
    "OCGT": {"p_min_pu": 0.15, "start_up_cost": 20, "min_up_time": 1, "min_down_time": 1,
             "ramp_limit_up": 1, "ramp_limit_start_up": 0.3, "ramp_limit_shut_down": 0.3},
    "CCGT": {"p_min_pu": 0.4, "start_up_cost": 100, "min_up_time": 2, "min_down_time": 2,
             "ramp_limit_up": 1, "ramp_limit_start_up": 0.5, "ramp_limit_shut_down": 0.5},
    "coal": {"p_min_pu": 0.3, "start_up_cost": 80, "min_up_time": 4, "min_down_time": 4,
             "ramp_limit_up": 0.8, "ramp_limit_start_up": 0.3, "ramp_limit_shut_down": 0.3},
    "lignite": {"p_min_pu": 0.3, "start_up_cost": 120, "min_up_time": 5, "min_down_time": 5,
                "ramp_limit_up": 0.7, "ramp_limit_start_up": 0.3, "ramp_limit_shut_down": 0.3},
    "nuclear": {"p_min_pu": 0.45, "start_up_cost": 200, "min_up_time": 6, "min_down_time": 8,
                "ramp_limit_up": 0.2, "ramp_limit_start_up": 0.2, "ramp_limit_shut_down": 0.2},
    "oil": {"p_min_pu": 0.2, "start_up_cost": 30, "min_up_time": 1, "min_down_time": 1,
            "ramp_limit_up": 1, "ramp_limit_start_up": 0.3, "ramp_limit_shut_down": 0.3},
    "urban central solid biomass CHP": {"p_min_pu": 0.35, "start_up_cost": 50, "min_up_time": 1, "min_down_time": 1,
                                        "ramp_limit_up": 0.9, "ramp_limit_start_up": 0.4, "ramp_limit_shut_down": 0.4},
}

uc_params_average = {
    "OCGT": {"p_min_pu": 0.2, "start_up_cost": 40, "min_up_time": 1, "min_down_time": 1,
             "ramp_limit_up": 1, "ramp_limit_start_up": 0.2, "ramp_limit_shut_down": 0.2},
    "CCGT": {"p_min_pu": 0.45, "start_up_cost": 150, "min_up_time": 3, "min_down_time": 2,
             "ramp_limit_up": 1, "ramp_limit_start_up": 0.45, "ramp_limit_shut_down": 0.45},
    "coal": {"p_min_pu": 0.325, "start_up_cost": 120, "min_up_time": 5, "min_down_time": 6,
             "ramp_limit_up": 0.7, "ramp_limit_start_up": 0.38, "ramp_limit_shut_down": 0.38},
    "lignite": {"p_min_pu": 0.325, "start_up_cost": 150, "min_up_time": 7, "min_down_time": 6,
                "ramp_limit_up": 0.6, "ramp_limit_start_up": 0.4, "ramp_limit_shut_down": 0.4},
    "nuclear": {"p_min_pu": 0.5, "start_up_cost": 250, "min_up_time": 6, "min_down_time": 10,
                "ramp_limit_up": 0.3, "ramp_limit_start_up": 0.3, "ramp_limit_shut_down": 0.3},
    "oil": {"p_min_pu": 0.2, "start_up_cost": 50, "min_up_time": 1, "min_down_time": 1,
            "ramp_limit_up": 0.8, "ramp_limit_start_up": 0.2, "ramp_limit_shut_down": 0.2},
    "urban central solid biomass CHP": {"p_min_pu": 0.38, "start_up_cost": 80, "min_up_time": 2, "min_down_time": 2,
                                        "ramp_limit_up": 0.7, "ramp_limit_start_up": 0.38, "ramp_limit_shut_down": 0.38},
}

uc_params_conservative = {
    "OCGT": {"p_min_pu": 0.25, "start_up_cost": 60, "min_up_time": 2, "min_down_time": 2,
             "ramp_limit_up": 0.9, "ramp_limit_start_up": 0.15, "ramp_limit_shut_down": 0.15},
    "CCGT": {"p_min_pu": 0.5, "start_up_cost": 200, "min_up_time": 4, "min_down_time": 3,
             "ramp_limit_up": 0.8, "ramp_limit_start_up": 0.35, "ramp_limit_shut_down": 0.35},
    "coal": {"p_min_pu": 0.35, "start_up_cost": 160, "min_up_time": 6, "min_down_time": 8,
             "ramp_limit_up": 0.5, "ramp_limit_start_up": 0.25, "ramp_limit_shut_down": 0.25},
    "lignite": {"p_min_pu": 0.35, "start_up_cost": 200, "min_up_time": 8, "min_down_time": 10,
                "ramp_limit_up": 0.4, "ramp_limit_start_up": 0.2, "ramp_limit_shut_down": 0.2},
    "nuclear": {"p_min_pu": 0.55, "start_up_cost": 400, "min_up_time": 10, "min_down_time": 12,
                "ramp_limit_up": 0.15, "ramp_limit_start_up": 0.15, "ramp_limit_shut_down": 0.15},
    "oil": {"p_min_pu": 0.25, "start_up_cost": 80, "min_up_time": 2, "min_down_time": 2,
            "ramp_limit_up": 0.6, "ramp_limit_start_up": 0.15, "ramp_limit_shut_down": 0.15},
    "urban central solid biomass CHP": {"p_min_pu": 0.4, "start_up_cost": 120, "min_up_time": 3, "min_down_time": 3,
                                        "ramp_limit_up": 0.5, "ramp_limit_start_up": 0.3, "ramp_limit_shut_down": 0.3},
}

def add_unit_commitment(n, uc_params=uc_params_average, carriers=["OCGT", "coal", "lignite", "urban central solid biomass CHP"], regions=["DE"]):
    """
...
if __name__ == "__main__":
    ...
    if unit_commitment["enable"]:
        logger.info(f"Add unit commitment in {unit_commitment['regions']} for carriers {unit_commitment['carriers']} with parameter set '{unit_commitment['params']}' to the network.")
        ...
        add_unit_commitment(n, uc_params, carriers=unit_commitment["carriers"], regions=unit_commitment["regions"])
