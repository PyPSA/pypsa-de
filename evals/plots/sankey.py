...
LINK_MAPPING = {
    ...
    ("Link", "H2 Fuel Cell", "AC"): ("Secondary H2 Out", "Secondary AC In"),
    ...
    ("StorageUnit", "PHS demand", "AC"): ("Secondary AC Out", "AC Storage"),
    ("StorageUnit", "PHS supply", "AC"): ("AC Storage", "Secondary AC In"),
    ("Link", "SMR", "H2"): ("", ""),
    ("Link", "SMR", "gas"): ("", ""),
    ("Link", "SMR", "gas losses"): ("", ""),
    ("Link", "SMR CC", "H2"): ("", ""),
