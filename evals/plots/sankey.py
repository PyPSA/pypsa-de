...
mapping = {
    ...
    ("Link", "methanolisation losses", "AC"): ("", ""),
    ("Link", "oil", "AC"): ("", ""),
    ("Link", "waste CHP", "AC"): ("", ""),
    ...
    ("Link", "H2 Electrolysis losses", "AC"): ("", ""),
    ("Link", "H2 OCGT", "AC"): ("", ""),
    ...
    ("Link", "H2 Fuel Cell losses", "H2"): ("", ""),
    ("Link", "Haber-Bosch", "H2"): ("", ""),
    ("Link", "Haber-Bosch losses", "H2"): ("", ""),
    ("Link", "Methanol steam reforming", "H2"): ("", ""),
    ("Link", "Methanol steam reforming CC", "H2"): ("", ""),
    ("Link", "SMR", "H2"): ("", ""),
    ("Link", "SMR CC", "H2"): ("", ""),
    ("Link", "Sabatier", "H2"): ("", ""),
    ("Link", "Sabatier losses", "H2"): ("", ""),
    ("Link", "ammonia cracker", "H2"): ("", ""),
    ("Link", "electrobiofuels", "H2"): ("", ""),
    ("Link", "electrobiofuels losses", "H2"): ("", ""),
    ("Link", "methanol-to-kerosene", "H2"): ("", ""),
    ("Link", "methanol-to-kerosene losses", "H2"): ("", ""),
    ...
    ("Link", "H2 OCGT", "H2"): ("", ""),
    ("Link", "H2 OCGT losses", "H2"): ("", ""),
    ("Link", "urban central H2 CHP", "H2"): ("", ""),
    ("Link", "urban central H2 CHP losses", "H2"): ("", ""),
...
class SankeyChart(ESMChart):
    ...
    def plot(self):
        ...
        df_agg["color"] = df_agg["bus_carrier"].map(COLOUR_SCHEME)
