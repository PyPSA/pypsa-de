...
networks : dict[str, pypsa.Network]
    ...
    recommended to use the fileio.read_networks function to
...
from evals.carbon_emission import eval_co2
from evals.curtailment import eval_curtailment
from evals.electricity import (
...
from evals.final_demand import (
    eval_fed,
    eval_fed_biomass,
...
from evals.heat import (
    eval_district_heat_balance,
    eval_district_heat_balance_ts,
)
from evals.hydrogen import eval_h2_balance, eval_h2_balance_ts
from evals.industry import eval_industry_sectoral, eval_industry_total
from evals.methane import eval_ch4_balance, eval_ch4_balance_ts
from evals.price import eval_capex, eval_market_value, eval_opex, eval_revenue
from evals.primary_energy import eval_heat_primary_energy
